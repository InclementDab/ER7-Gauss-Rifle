...
class ER7_CLO_BU0 extends WeaponStableState
{
	...
	override int GetCurrentStateID () { return ER7StableStateID.ER7_CLO_BU0; }
...
class ER7_CLO_BU1 extends WeaponStableState
{
	...
	override int GetCurrentStateID () { return ER7StableStateID.ER7_CLO_BU1; }
...
class ER7_OPN_BU0 extends WeaponStableState
{
	...
	override int GetCurrentStateID () { return ER7StableStateID.ER7_OPN_BU0; }
	override bool HasBullet () { return false; }
	override bool HasMagazine () { return false; }
	override bool IsJammed () { return false; }
...
class ER7_JAM_BU1 extends WeaponStateJammed
{
	...
	override int GetCurrentStateID () { return ER7StableStateID.ER7_JAM_BU1; }
	override bool HasBullet () { return true; }
	override bool HasMagazine () { return false; }
...
class ER7_Gauss_Base : Rifle_Base
{
	...
	override void InitStateMachine()
	{
		...
		// regexp: [CLJ][01][01]
		C0 = new ER7_CLO_BU0(this, NULL, ER7AnimState.DEFAULT);
		C1 = new ER7_CLO_BU1(this, NULL, ER7AnimState.DEFAULT);
		L0 = new ER7_OPN_BU0(this, NULL, ER7AnimState.OPENED);
		JF = new ER7_JAM_BU1(this, NULL, ER7AnimState.JAMMED);
